# Phaser Editor Parcel TypeScript Template

This is a Phaser Editor v4 project template that uses Parcel TypeScript for bundling. It supports hot-reloading for quick development workflow and includes scripts to generate production-ready builds.
